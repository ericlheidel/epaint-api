# Generated by Django 5.0.4 on 2024-04-27 00:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='orders', to='epaintapi.payment')),
            ],
        ),
        migrations.CreateModel(
            name='OrderPaint',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(100.0)])),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='orderpaints', to='epaintapi.order')),
                ('paint', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='orderpaints', to='epaintapi.paint')),
                ('size', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='orderpaints', to='epaintapi.size')),
            ],
        ),
        migrations.CreateModel(
            name='UserInfo',
